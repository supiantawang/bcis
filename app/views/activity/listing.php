	...
	<div class="col-md-12">
		<div class="box">
            ...
            <div class="box-body">
				...
				<div class="text-right1"><a href="<?php echo base_url()?>index.php/activity/add"><span class="btn btn-primary">Tambah Baru</span></a><br><br></div>
				...
				$exercises = $this->blapps_lib->getDataResult("tb_activity",array(array("act_activity_type",1)),"",array("tb_activity.topic_id","ASC"));
				if($exercises){
					$no =  1;
					foreach($exercises as $row){
						...
						echo "<tr>";
							...
							echo "<td>
							<a href='".base_url()."index.php/activity/edit/".base64_encode($row->act_id)."'><span class='btn btn-xs btn-warning'>Edit</span></a>
