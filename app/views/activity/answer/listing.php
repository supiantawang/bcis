<section class="content-header">
      <h1>
        Senarai Jawapan Aktiviti
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Halaman Utama</a></li>
        <li>Aktiviti</li>
        <li class="active">Senarai Jawapan Aktiviti</li>
      </ol>
    </section>
	...
	<div class="col-md-12">
		<div class="box">
            ...
            <div class="box-body">
				...
				<div class="text-right1"><a href="<?php echo base_url()?>index.php/activity/addanswer"><span class="btn btn-primary">Tambah Baru</span></a><br><br></div>
				...
				$results = $this->blapps_lib->getDataResult("tb_activity_answer",array(array("act_activity_type",1)),"",array("tb_activity_answer.acta_id","ASC"));
				if($results){
					$no =  1;
					foreach($results as $row){
						...
						echo "<tr>";
							...
							echo "<td>
							<a href='".base_url()."index.php/activity/editanswer/".base64_encode($row->acta_id)."'><span class='btn btn-xs btn-warning'>Edit</span></a>
