      ...
      <div class="row">
		...
		<div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class=""><a href="#tab_5" data-toggle="tab" aria-expanded="false"><h5><b>5. Temuduga</b></h5></a></li>
				...
				<div class="row">
					...
					<div class="panel box box-default">
						...
						<div class="box-body">
							...
							<table class="table table-bordered table-striped">
							<tr>
								<th width="30%">Penilaian Temuduga</th>
								<td><?php echo ($user->u_overall_result == 4) ? "Lulus" : "Gagal" ?></td>
							</tr>
							<tr>
								<th>Ulasan Temuduga</th>
								<td><?php echo $user->u_interview_remarks ?></td>
							</tr>
							<tr>
								<th>Penemuduga</th>
								<td><?php echo $this->blapps_lib->getData("u_fullname","ek_admin","u_id",$user->u_interviewer) ?></td>
							</tr>
							<tr>
								<th>Tarikh</th>
								<td><?php echo $user->u_interview_date ?></td>
							</tr>
							</table>
						</div>
						<div class="box-footer">
							
							<input type="button" value="Kembali" class="btn btn-default" onclick="history.go(-1)">
						</div>
					</div>
					</div>
				</div>
