...
if($this->uri->segment(4)){
	...
	$alert		= "";
	$disabled	= "";
	if(get_cookie("_urole") != 1 && get_cookie("_userID") != $air->isu_createdby){
            ...
            <?php echo form_open_multipart($action); ?>
              <div class="box-body">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="form-group">
						  <label for="inputKategori">Tarikh <font color="red">*</font></label>
						  <div class="input-group date">
								<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
								<?php echo form_input("tarikh",$vtarikh,"class='form-control pull-right datepicker' autocomplete='off' required")?>
							</div>
						</div>
					</div>
