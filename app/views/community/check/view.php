      ...
      <div class="row">
		...
		<div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class=""><a href="#tab_5" data-toggle="tab" aria-expanded="false"><h5><b>4. Markah Pentaksiran</b></h5></a></li>
              <li class=""><a href="#tab_4" data-toggle="tab" aria-expanded="false"><h5><b>5. Tindakan</b></h5></a></li>-->
            ...
            <div class="tab-content">
							  ...
							  <table class="table table-bordered table-striped">
								...
								if($teach || $activ){
									...
									foreach($activ as $rec){
										...
										if($rec->act_name == "Latihan"){
											$this->db->limit(1);
											$this->db->where("clq_is_completed",1);
											$this->db->where("act_id",$rec->act_id);
											$this->db->where("u_id",$user->u_id);
											$this->db->join("tb_activity_question","tb_activity_question.aque_id = tb_click_log_question.aque_id");
											$this->db->from("tb_click_log_question");
											$grap = $this->db->get()->row();
											
											if($grap){
												$cek = $grap->clq_datetime; 
												$status = "<span class='label label-success'>Selesai</span>"; 
											}else{
												$cek="-";
												$status="<span class='label label-warning'>Belum Selesai</span>";
				...
				<div class="row">
					<div class="col-md-6">
						...
						?>
							...
							<video width="100%" controls>
								<source src="<?php echo FRONT_END."public/".$vid->vide_file_link ?>" type="video/mp4">
								<source src="<?php echo FRONT_END."public/".$vid->vide_file_link ?>" type="video/ogg"> 
							</video>
							
							<label>Muat Naik Pada:</label> <?php echo $vid->vide_upload_date ?><br>
							<label>Pautan:</label> <a href="<?php echo FRONT_END."public/".$vid->vide_file_link ?>" target="_blank">Lihat</a>
						<?php  endforeach; ?>
						<?php  }else{ ?>
					...
					<div class="col-md-6">
					<?php echo form_open_multipart("student/update/status"); ?>
					<div class="panel box box-default">
						<div class="box-header with-border"></div>
						<div class="box-body">
							
							<div class="form-group">
							  <label>Penilaian Tugasan Video <font color="red">*</font></label>
							  <?php echo form_dropdown("penilaian",array(''=>'- Sila Pilih -','1'=>'Lulus','0'=>'Gagal'),"","class='form-control' id='penilaian' required")?>
							</div>
							<div class="form-group">
							  <label>Ulasan Tugasan Video </label>
							  <?php echo form_textarea("remarks","","class='form-control' id='remarks'")?>
							</div>
							<div class="form-group">
							  <label>Penemuduga <font color="red">*</font></label>
							  <?php echo form_dropdown("interviewer",$interviewer,$user->u_interviewer,"class='form-control' id='interviewer' required")?>
							</div>
							<?php echo form_hidden("penilai","admin")?>
						...
						<div class="box-footer">
							...
							<?php }else{ ?>
							<input type="submit" value="Hantar" class="btn btn-primary" disabled>
							<?php } ?>
						</div>
					<?php echo form_close() ?>	  
					</div>
				...
				<div class="row">
					<div class="col-md-8">
						...
						foreach($tb_topic_institution as $topic):
							$markah = 0;
							$this->db->join("tb_activity_question","tb_activity_question.aque_id = tb_user_answer.aque_id");
							$this->db->join("tb_activity","tb_activity.act_id = tb_activity_question.act_id");
							$jawapan = $this->blapps_lib->getDataResult("tb_user_answer",array(array("tb_user_answer.u_id",$user->u_id),array("topic_id",$topic->topic_id),array("act_name","Latihan")),"",array("","ASC"));
							if($jawapan){
								$bilangan = count($jawapan);
								
								$betul = 0;
								foreach($jawapan as $bet){
									if($bet->uans_score == 1){
										$betul = $betul+1;
									}
								}
								$markah = $betul."/".$bilangan;
								$gtotal = $gtotal+$bilangan;
								$gbetul = $gbetul+$betul; 
							}
							if($gbetul != 0)
							$peratus = $gbetul / $gtotal * 100;
						?>
						<tr>
							<td><?php echo $no ?></td>
					...
					<div class="col-md-2">
						...
						<div class="small-box bg-aqua">
							<div class="inner">
							  <h3><?php echo $gbetul?>/<?php echo $gtotal?></h3>
					...
					<div class="col-md-2">
						...
						<div class="small-box bg-maroon">
							<div class="inner">
							  <h3><?php echo number_format($peratus,1) ?>%</h3>
                ...
                <div class="responsive">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
						  ...
						  <?php echo form_input("xresit","","class='form-control' disabled")?>
						</div>
