<?php
    ...
    $results = $this->blapps_lib->getDataResult("tb_cert_item",array(array('cert_id',$certid),array('item_status',1)),"", array("item_ordering","ASC"));
    define("IMAGE", $img);
	...
	$key = $noic.$tarikhtamat;
	$pdf->write2DBarcode(sha1($key), 'QRCODE,L', 170, 20, 15, 15, $style, 'N');
	$pdf->Ln(3);
