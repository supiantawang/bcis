...
if($this->uri->segment(4)){
	$title 		= "Kemaskini";
	$action 	= "program/update/agency/".$this->uri->segment(4);
            ...
            <?php echo form_open_multipart($action); ?>
              <div class="box-body">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
						  <label for="inputKategori">Nama Program <font color="red">*</font></label>
						  <?php echo form_input("title",$vtitle,"class='form-control' required")?>
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
						  <label for="inputKategori">Jenis Program <font color="red">*</font></label>
						  <?php echo form_dropdown("jenis",$jenis,$vjenis,"class='form-control' required")?>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
						  <label for="inputKategori">Kategori Program</label>
